...
Done well, Phase 1 will generate brand visibility and ongoing connections, particularly with young adults as the likely widespread recipients of Saved laptops. 

A deep connection to the brand’s values creates the opportunity for **qualification pathways** and a **hybrid retail presence**.

#### Qualification pathways

Saved develops and provides **qualifications** in sovereign and resilient technologies; these would be:

- Accredited through partnering vocational tertiary providers and open source foundations 
- Delivered with a studio model, with a mobile studio to reach remote areas an option
- Hubbed from a dedicated learning space, ready for a hybrid retail presence.
...
The retail presence is imagined to have a strikingly visual “open kitchen” approach to its Saved laptop process automation, and also serve as a drop-in centre and workshop space.

### Phase 3: Expansion

It is expected that Phase 1 &amp; 2 will generate valuable know-how and IP that can be realised commercially through **enterprise services** and **nationwide franchising**.
